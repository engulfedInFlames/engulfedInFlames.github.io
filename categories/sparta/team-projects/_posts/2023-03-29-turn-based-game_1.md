...
&nbsp;&nbsp; 이에 대해 팀원들을 납득시키기는 했습니다만, 사실 제가 멋대로 정한 것이기도 합니다. 클래스는 독립적이어야 하고... 캡슐화되어야 하고... 등등 객체 지향 언어의 특징을 지키면서 코딩을 하면 좋겠지만, 저도 남한테 요령 있게 설명할 만큼 자세하고 정확하게 알고 있는 실정은 아닙니다만, 그럼에도 불구하고 저 두 원칙만은 지키면서 가면 좋을 것 같다고 제안했습니다. 비록 파이썬에서는 클래스 내 protected 변수에 대한 강제성이 없다 하더라도 말입니다. 한편으로, 저렇게 해야 1 대 다, 또는 다 대 다 전투 시스템을 구현할 때에 편리할 것이라 생각했습니다.
...
&nbsp;&nbsp; 기존 게임에서는 플레이어 객체가 생성되면 자동으로 몬스터가 생성되고, 곧바로 전투에 돌입하게 되어 있었습니다. 이 일련의 과정들이 한 가지로 동작했고, 몬스터와의 전투에서 승리하거나 패배하면 게임은 종료됐습니다.

&nbsp;&nbsp; 하지만 이제는 게임이 종료되면 안 됩니다. 몬스터를 무찌르고 난 뒤에 경험치와 보상을 얻고, 유저 스스로가 모험을 할 것인지, 아니면 게임을 종료할 것인지 등 상호작용할 수 있는 선택지를 만들어야만 합니다. 어떻게 하면 좋을까 하다가 간단하게
